  ...
  return (
    ...
    <div className='max-w-[420px] w-full px-9 py-11 bg-[#fff] rounded-[24px] flex flex-col mx-auto'>
      ...
      <div className="flex flex-col gap-5">
          ...
          }} color='info' style={{width: '100%', fontSize: '16px', fontFamily: "Nunito Sans"}} id="email-outlined" label="Username" type='text' variant="outlined" size='medium'/>
    ...
    <div className="w-full flex flex-row justify-center mt-4">
        <Link to='/forgot-password' className='text-[#1570EF] text-sm font-semibold hover:text-zinc-400'>Forgot Password?</Link>
    </div>
    {loading && (
      <LoadingProgress  />
    )}
